...
var captureTemplate = document.getElementById('capture-template').innerHTML;
...
Mustache.parse(captureTemplate);
	...
	chrome.storage.local.get(null, function (obj) {
		$.jsonRPC.request('getGlobalStat', {
			...
			success: function (result) {
				...
				capturePlaceholder.innerHTML = Mustache.render(captureTemplate, res, {
					state: settings.get('captureCheckbox') ? 'ON' : 'OFF',
				});
